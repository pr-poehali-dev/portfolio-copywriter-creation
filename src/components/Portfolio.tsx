...
const portfolioData: PortfolioItem[] = [
  ...
  },
  {
    ...
    type: 'Статья',
    description: 'SEO-оптимизированная статья для онлайн-школы о выборе востребованной профессии в современных реалиях. Глубокий анализ рынка труда, трендов 2024 года и практические рекомендации для абитуриентов. Материал учитывает боли целевой аудитории и отвечает на ключевые вопросы о карьерном развитии.',
